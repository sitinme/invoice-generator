...
import type { InvoiceData, InvoiceItem, TemplateStyle } from '@/lib/types';
import {
  generateId,
  formatCurrency,
  formatDate,
...
const InvoicePreviewHTML = dynamic(() => import('@/components/invoice-preview/InvoicePreviewHTML'), {
  ssr: false,
});

const PDFDownloadButton = dynamic(() => import('@/components/invoice-preview/PDFDownloadButton'), {
  ssr: false,
});
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <p className="mt-1 text-gray-600">Fill in the details below and download your professional invoice as PDF.</p>
        </div>
      </div>
